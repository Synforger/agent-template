...
echo "  1. Edit CLAUDE.md (= 人格 / 起動プロトコル)"
echo "  2. Edit profile/profile-core.md (= 主たるユーザのプロファイル核)"
echo "  3. Edit .tooling/local-ci/anon-words.txt (= 禁止語彙、 gitignored)"
echo "  4. Add agent-specific rules under rules/always/ (= *-local.md 命名推奨)"
echo "  5. (optional) cp .tooling/pc-labels.example.txt .tooling/pc-labels.txt + 編集"
